        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="max-7w-xl">
                    ...
                    <form method="post" action="{{ route('assets.update', ['asset' => $asset->id]) }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="value" class="form-control" type="number" name="value"
                                :value="old('value', $asset->value)" required />
                            <x-input-error class="mt-2" :messages="$errors->get('value')" />
                        </div>

                        <div>
                            <x-input-label for="amount" :value="__('Jumlah')" />
                            <x-text-input id="amount" class="form-control" type="text" name="amount"
                                :value="old('amount', $asset->amount)" autofocus />
                            <x-input-error class="mt-2" :messages="$errors->get('amount')" />
                        </div>
                        <div>
                            <x-input-label for="location" :value="__('Lokasi')" />
                            <x-text-input id="location" class="form-control" type="text" name="location"
                                :value="old('location', $asset->location)" autofocus />
